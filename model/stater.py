...
class Stater(LlamaPreTrainedModel):
    # _keys_to_ignore_on_load_missing = [r"actor.weight", r"entity_embedding.weight", r"relation_embedding.weight"]
